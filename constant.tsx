...
export const server_url: string = "http://api.troisplay.com:41007/api";
export const dev_url: string = "http://localhost:4050/api";
export const dev_url_media: string = "http://localhost:4050/";
export const server_url_socket: string = "http://api.troisplay.com:41007/";
export const server_url_media: string = "http://api.troisplay.com:41007/";
